...
namespace LurnApp.Android.Fragments
{
	...
	public class NavigationFragment : Fragment
	{
		...
		void SetActiveAssignment ()
		{
			...
			if (Assignment.IsHistory) {
				...
				case AssignmentStatus.New:
					navigationStatusLayout.Visibility = timerLayout.Visibility = ViewStates.Gone;
					break;
				...
				case AssignmentStatus.Complete:
					navigationStatusLayout.Visibility = timerLayout.Visibility = ViewStates.Visible;
					navigationStatusImage.SetImageResource (Resource.Drawable.EnrouteImage);
		...
		class NavigationItemSelectorListener : Java.Lang.Object, AdapterView.IOnItemClickListener
		{
